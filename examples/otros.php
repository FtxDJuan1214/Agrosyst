    ...
    <div class="main-content">
      ...
      <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        <div class="container-fluid">
          ...
          ?>
          <a class="h2 mb-0 text-white text-uppercase  d-lg-inline-block"><?php echo $finca[1]." "?><i class="fas fa-angle-right"></i> OTROS / GASTOS</a>
          <!-- Form -->
              ...
              <div class="modal-body p-0">
                <div class="card bg-secondary shadow border-0">
                  ...
                  <div class="card-body px-lg-5 py-lg-5">
                    ...
                    <form role="form" id="form-up-otr">

                      <div class="form-group mb-3">
                        <div class="input-group input-group-alternative" id="div_des_insup">
                          <input style="border-color: #fb6340;"  id="des_insup" type="text" class="form-control" placeholder="Nombre" autocomplete="off" maxlength="43">
                        </div>
                      </div>                 
...
<div class="row">
  <div class="col">
    <div class="card shadow">
      ...
      <div class="table-responsive"  id="tab_otros">
  ...
  <div class="modal fade" id="modal-manual" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content" style="border-radius: 4px;">
        ...
        <embed src="../manuales/interfaz_gastos.pdf" type="application/pdf" width="100%" height="600"/>
      </div>
    </div>
  </div>
<!------------------------------------------------------------------------- -->
...
<!-- funciones -->
<script src="../js/funciones_otros.js"></script>
</body>
</html>
