                                        ...
                                        <form role="form" id="form-add-iac">
                                            ...
                                            <div class="form-group mb-3">
                                                <div class="input-group input-group-alternative">
                                                    ...
                                                    <ul>  
                                                        <label><input type="checkbox" value="SI" name ="ica1" class="ica" id="ica1" onchange="checks()">Si</label><br>
                                                        <label><input type="checkbox" value="NO" name ="ica2" class="ica" id="ica2" onchange="checks()">No</label><br>
                                                    </u>
                                                </div>
                                            </div> 
                                        ...
                                        <form role="form" id="form-up-sem">
                                            ...
                                            <div class="form-group mb-3">
                                                <div class="input-group input-group-alternative">
                                                    <p>¿Está aprobado por el ICA?:</p>
                                                    <ul>  
                                                        <label><input type="checkbox" value="SI" name ="ica1" class="ica" id="ica1up" onchange="checks()">Si</label><br>
                                                        <label><input type="checkbox" value="NO" name ="ica2" class="ica" id="ica2up" onchange="checks()">No</label><br>
                                                    </u>
                                                </div>
                                            </div> 
                                            <!----------------------------------------------------------------------------> 
