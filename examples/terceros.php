  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        ...
        ?>
        <a class="h2 mb-0 text-white text-uppercase  d-lg-inline-block"><?php echo $finca[1]." "?><i class="fas fa-angle-right"></i> Terceros</a>
        <!-- Form -->
    ...
    <!-- Header -->
    <div class="header pb-8 pt-5 pt-md-8" style="background: url('../assets/img/theme/farmer.jpg'); no-repeat; background-size: cover;">
              ...
              <div class="modal-body p-0">
                ...
                <div class="card bg-secondary shadow border-0">
                  ...
                  <div class="card-body px-lg-5 py-lg-5">
                    ...
                    <form role="form" id="form-up-ter">
                      <div class="form-group mb-3" style="display: none;">
                        <div class="input-group input-group-alternative">
                          <input id="ide_terup" type="text" class="form-control " placeholder="Cédula" autocomplete="off" disabled>
                        </div>
                      </div>

                      <div class="form-group mb-3">
                        <div class="input-group input-group-alternative">
                          <input id="ver_ced" type="text" class="form-control " placeholder="Cédula" autocomplete="off" disabled>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-sm-12">
                          <div class="row">
                            <div class="col-8 col-sm-6">
                              <div class="form-group mb-3">
                                <div class="input-group input-group-alternative" id="div_pno_terup">
                                  <input  style="border-color: #fb6340;" id="pno_terup" type="text" class="form-control" placeholder="Primer nombre" autocomplete="off" maxlength="20">
                                </div>
                              </div>

                              <div class="form-group mb-3">
                                <div class="input-group input-group-alternative">
                                  <input id="sno_terup" type="text" class="form-control" placeholder="Segundo nombre" autocomplete="off" maxlength="20">
                                </div>
                              </div>
                            </div>
                            <div class="col-4 col-sm-6">
                              <div class="form-group mb-3">
                                <div class="input-group input-group-alternative" id="div_pap_terup">
                                  <input  style="border-color: #fb6340;" id="pap_terup" type="text" class="form-control" placeholder="Segundo apellido" autocomplete="off" maxlength="20">
                                </div>
                              </div><div class="form-group mb-3">
                                <div class="input-group input-group-alternative" id="div_sap_terup">
                                  <input  style="border-color: #fb6340;" id="sap_terup" type="text" class="form-control" placeholder="Segundo apellido" autocomplete="off" maxlength="20">
                                </div>
                              </div>
                            </div>
                          </div>
