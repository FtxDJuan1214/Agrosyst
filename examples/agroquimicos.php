...
<body>
    ...
    <div class="main-content">
        ...
        <div class="header pb-8 pt-5 pt-md-8"
            style="background: url('../assets/img/theme/agroquimicos.png'); no-repeat; background-size: cover;">
                        ...
                        <div class="modal-content">
                                    ...
                                    <div class="card-body px-lg-5 py-lg-5">
                                        ...
                                        <form role="form" id="form-add-agr">
                                            ...
                                            <div class="form-group mb-3">
                                                <div class="input-group input-group-alternative">
                                                    <input id="cod_agr" name="cod_agr" type="text" class="form-control"
                                                        placeholder="Código agroquímico" autocomplete="off">
                                                </div>
                                            </div>

                                            <div class="form-group mb-3">
                                                <div class="input-group input-group-alternative">
                                                    <input id="det_agr" name="det_agr" type="text" class="form-control"
                                            ...
                                            <div class="form-group mb-3">
                                                <div class="input-group input-group-alternative">
                                                    <input id="des_ins" name="des_ins" type="text" class="form-control"
                                                        placeholder="Detalles" autocomplete="off">
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label for="det_agr">Recomendaciones</label>
                                                <textarea id="rec_agr" name="rec_agr" class="form-control"
                                                    rows="2"></textarea>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                <div class="input-group input-group-alternative">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <p align='center'>Si</p>
                                                            <input type="radio" name="etapa">
                                                        </label>
                                                        </li>

                                                        <li>
                                                            <input type="radio" name="est_agr" id="est_agr"
                                                                value="Líquido">
                                            ...
                                            <div class="form-group mb-3">
                                                <div class="input-group input-group-alternative">
                                                    <input id="pcr_agr" name="pcr_agr" type="text" class="form-control"
                                                        placeholder="Periodo de carencia (en horas)" autocomplete="off">
                                                </div>
                                            </div>

                                            <div class="form-group mb-3">
                                                <div class="input-group input-group-alternative">
                                                    <input id="pen_agr" name="pen_agr" type="text" class="form-control"
                                                        placeholder="Periodo de entrada (en horas)" autocomplete="off">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                <div class="input-group input-group-alternative">
                                                    <input id="for_agr" name="for_agr" type="text" class="form-control"
                                                        placeholder="Formulación" autocomplete="off">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                <div class="input-group input-group-alternative">
                                                    <select id="cod_tox" name="cod_tox" class="form-control"
                                                        data-live-search="true">
                                                        <option value="" disabled selected>Selecciona un nivel de
                                                            Toxicidad</option>
                                                        <?php 
                                            ...
                                            <div class="form-group mb-3">
                                                <div class="input-group input-group-alternative">
                                                    <select id="tip_uni_med" name="tip_uni_med" class="form-control"
                                                        data-live-search="true">
                                                        <option value="" disabled selected>Selecciona un tipo de medida
                                                        </option>
                                                        <?php 
                         ...
                         ?>
                                            ...
                                            <div class="text-center">
                                                <button type="button" class="btn btn-primary my-4" id="btn_save"
                                ...
                                <div class="card bg-secondary shadow border-0">
                                    ...
                                    <div class="card-body px-lg-5 py-lg-5">
                                        ...
                                        <form role="form" id="form-up-agr">
                                            ...
                                            <div class="form-group mb-3">
                                                <div class="input-group input-group-alternative">
                                                    <input id="des_insup" type="text" class="form-control"
                                                        placeholder="Nombre" autocomplete="off">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                <div class="input-group input-group-alternative">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <input type="radio" name="est_agrup" id="est_agrup"
                                                                value="Sólido">
                                            ...
                                            <div class="form-group mb-3">
                                                <div class="input-group input-group-alternative">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <input type="radio" name="cla_agrup" id="cla_agrup"
                                                                value="Fertilizante">
                                            ...
                                            <div class="form-group mb-3">
                                                <div class="input-group input-group-alternative">
                                                    <select id="tip_uni_medup" name="tip_uni_med" class="form-control"
                                                        data-live-search="true">
                                                        <option value="" disabled selected>Selecciona un tipo de medida
                                                        </option>
                                                        <?php 
