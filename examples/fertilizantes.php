    ...
    <div class="main-content">
      ...
      <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        <div class="container-fluid">
          ...
          ?>
          <a class="h2 mb-0 text-white text-uppercase  d-lg-inline-block"><?php echo $finca[1]." "?><i class="fas fa-angle-right"></i> fertilizantes</a>
          <!-- Form -->
                       ...
                       <div class="form-group mb-3">
                        <div class="input-group input-group-alternative">
                         <select id="cod_unm" name="cod_unm" class="form-control"data-live-search="true">
                          ...
                          <?php 
                          $query="SELECT cod_unm, des_unm FROM unidad_de_medida WHERE cod_tum='3'  or cod_tum='4' or cod_tum='6' or cod_tum='7'";
...
<div class="row">
  <div class="col">
    <div class="card shadow">
      ...
      <div class="table-responsive"  id="tab_fertilizantes">
  ...
  <div class="modal fade" id="modal-manual" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content" style="border-radius: 4px;">
        ...
        <embed src="../manuales/interfaz_fertilizantes.pdf" type="application/pdf" width="100%" height="600"/>
      </div>
    </div>
  </div>
<!------------------------------------------------------------------------- -->
...
<!-- funciones -->
<script src="../js/funciones_fertilizantes.js"></script>
</body>
</html>
