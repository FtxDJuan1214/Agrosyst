    ...
    <div class="main-content">
      ...
      <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        <div class="container-fluid">
          ...
          ?>
          <a class="h2 mb-0 text-white text-uppercase  d-lg-inline-block"><?php echo $finca[1]." "?><i class="fas fa-angle-right"></i> semilleros</a>
          <!-- Form -->
      ...
      <!-- Header -->
      <!-- Header -->
      <div class="header pb-8 pt-5 pt-md-8" style="background: url('../assets/img/theme/semilleros.jpg'); no-repeat; background-size: cover;">
                  ...
                  <div class="card bg-secondary shadow border-0">
                    <div class="card-body px-lg-5 py-lg-5">
                      <div class="text-center text-muted mb-4">
                        <h3>Agregar Semillero</h3>
                      </div>
                      <form role="form" id="form-add-smr">


                        <div class="form-group mb-3">
                          <div class="input-group input-group-alternative" id="div_des_ins">
                            <input style="border-color: #fb6340;" id="des_ins" type="text" class="form-control" placeholder="Nombre" autocomplete="off">
                          </div>
                        </div>

                        <div class="form-group mb-3">
                          <div class="input-group input-group-alternative">
                            <select id="cod_tso" name="cod_tso" class="form-control"data-live-search="true">
                              <option value="" disabled selected>Selecciona tipo de semillero</option>
                              <?php 
                              $query="SELECT* FROM tipo_semillero";
                       ...
                       <label for="det_smr">Detalle</label>
                       <div class="input-group-alternative" id="div_det_smr">
                        <textarea style="border-color: #fb6340;" id="det_smr" class="form-control" rows="2"></textarea>
                      </div>
                ...
                <div class="card bg-secondary shadow border-0">
                  ...
                  <div class="card-body px-lg-5 py-lg-5">
                    ...
                    <form role="form" id="form-up-smr">
                      ...
                      <div class="form-group mb-3">
                        <div class="input-group input-group-alternative">
                          <select id="cod_tsoup" name="cod_tso" class="form-control"data-live-search="true">
                            <option value="" disabled selected>Selecciona tipo de semillero</option>
                            <?php 
                            $query="SELECT* FROM tipo_semillero";
                            $result =pg_query($conexion,$query);
                     ...
                     <label for="det_smr">Detalle</label>
                     <div class="input-group-alternative" id="div_det_smrup">
                      <textarea style="border-color: #fb6340;"  id="det_smrup" class="form-control" rows="2"></textarea>
                    </div>
    ...
    <div class="row">
      <div class="col">
        <div class="card shadow">
          ...
          <div class="table-responsive"  id="tab_semilleros">
  ...
  <div class="modal fade" id="modal-manual" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content" style="border-radius: 4px;">
        ...
        <embed src="../manuales/interfaz_semilleros.pdf" type="application/pdf" width="100%" height="600"/>
      </div>
    </div>
  </div>
<!------------------------------------------------------------------------- -->
...
<!-- funciones -->
<script src="../js/funciones_semilleros.js"></script>
</body>
</html>