      ...
      <div class="table-responsive">
        <table class="table align-items-center table-dark table-flush">
          ...
          <tbody>
            ...
            AND act_cul.cod_cul=cultivos.cod_cul AND cultivos.cod_cul = '$cod_cul' AND stock.can_sto != '0'
              ...
              if ($filas == 0) {
                ...
                <td>
                  <div class="form-group mb-3" style="max-width: 100px;">
                    <div class="input-group input-group-alternative" id="div_cant_usarup<?php echo $ver[0] ?>">
                      <input style="border-color: #fb6340;" id="cant_usarup<?php echo $ver[0] ?>" type="number" class="form-control" placeholder="Cantidad a usar" autocomplete="off">
                    </div>
                  </div>
                </td>
                <td>
                ...
                <td> <button class="btn btn-sm btn-secondary btn-icon-only rounded-circle" type="button" 
                  onclick="addinsumosup('<?php  echo $cod_tar.','.$ver[0].','.$ver[1].','?>'+$('#cant_usarup<?php echo $ver[0] ?>').val()+'<?php echo ','.$precio.','.$total_tar.','.$cod_cul ?>');">
