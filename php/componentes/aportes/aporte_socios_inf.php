  ...
  while ($ver=pg_fetch_row($resultasda)) {
   ...
   if ($aporte_total_cultivo != 0 ) {
     ...
     <div class="row col-md-12"  style="margin: 10px auto;">
      <div class="card bg-gradient-default col-md-12">
        <div class="card-body">
          ...
          foreach($convenios_aporte as $tercero=>$total)
          {
            ...
            <div class="col">
              ...
              <div class="progress progress-xs my-2">
                <div class="progress-bar bg-gradient-danger" style="width: <?php echo round($porcentaje = ($total * 100) / $aporte_total_cultivo)  ?>%"></div>
              </div>
            </div>
            <?php
      ...
      if(abs($dif = ($porb - $pora )) >= 0 && abs($dif = ($porb - $pora )) <= 10 ){
        ...
        ?>
        <div class="col-md-12 " style="margin-top: 10px auto; margin-top: 10px;">
        ...
        <div class="col-md-12" style="margin-top: 10px auto; margin-top: 10px;">
          <div class="alert alert-warning" role="alert">
            ...
            <span class="alert-text"><strong>Atención!</strong>  La diferencia de aportes está en <?php echo abs($dif = ($porb - $pora ))?>%, Se recomienda que 
              ...
              ?>
            realice las siguientes compras o convenios, para que la diferencia de aportes disminuya.</span>
          </div>
        </div>
        <?php
      }
