                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group input-group-alternative" id="div_nom_agr">
                                                    <input style="border-color: #fb6340;" type="text"
                                                        class="form-control" id="nom_agr" name="nom_agr"
                                                        pattern="[A-Za-z0-9]{1,50}" placeholder="Nombre" min="1"
                                                        max="50" required>
                                                </div>
                                            </div>
                                            <!--Div Prentación-->
                                            <div class="form-group">
                                                <div class="input-group input-group-alternative" id="div_pre_agr">
                                                    <input style="border-color: #fb6340;" type="text"
                                                        class="form-control" id="pre_agr" name="pre_agr"
                                                        pattern="[A-Za-z0-9]{1,5}" data-toggle="tooltip"
                                                        data-placement="left"
                                                        title="Presentación de producto. Ejemplo: 1L"
                                                        placeholder="Presentación" min="1" max="5" required>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <!--Div Dosis-->
                                            <div class="form-group">
                                                <div class="input-group input-group-alternative" id="div_dos_agr">
                                                    <input style="border-color: #fb6340;" type="text"
                                                        class="form-control" id="dos_agr" name="dos_agr"
                                                        pattern="[A-Za-z0-9]{1,10}" data-toggle="tooltip"
                                                        data-placement="left" title="Dosis recomendada a usar."
                                                        placeholder="Ej: 00cc/Ha" required>
                                                </div>
                                            </div>
                                            ...
                                            <!--Div Nombre Entrada-->
                                            <div class="form-group">
                                                <div class="input-group input-group-alternative" id="div_pen_agr">
                                                    <input style="border-color: #fb6340;" type="number"
                                                        class="form-control" id="pen_agr" name="pen_agr"
                                            ...
                                            <!--Div Nombre Carencia-->
                                            <div class="form-group">
                                                <div class="input-group input-group-alternative" id="div_pcr_agr">
                                                    <input style="border-color: #fb6340;" type="number"
                                                        class="form-control" id="pcr_agr" name="pcr_agr"
                                                        data-toggle="tooltip" data-placement="left"
                                        ...
                                        <div class="col-md-6">
                                            <center>
                                                <button class="btn btn-danger" text
                                                    ...
                                                    title="Cancelar operacion" onclick="cancelar();">Cancelar
                                                </button>
                                            </center>
                                        </div>
                                        <div class="col-md-6">
                                            <center>
                                                <button id="guardar_agrob" name="guardar_agrob" class="btn btn-success"
                                                    ...
                                                    data-toggle="tooltip" data-placement="left" type="button"
                                                    title="Guardar" onclick="guardar_agro();">Guardar
                                                </button>
                                            </center>
                                        </div>
                                    </div>
